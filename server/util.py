...
#...............................................................................
def load_tsp_problems():
    tsp_problems = []
    count = 9
    optima = [27603, 9352, 95345, 11340,
              6656, 837479, 172387, 79114, 4566563]

    with open('tsp_problems.txt') as fp:
        line = fp.readline()
        count = 0
        while line:
            if len(line.split()) == 1:
        ...
        fp.close()
    return [
        {"cities": len(problem), "points": problem,
         "optimum": optimum, "index": index}
        for problem, optimum, index in zip(tsp_problems, optima, [i for i in range(count)])
    ]
...
def load_fe_problems():
    return [
        {"name": "Ackley", "minimize": True, "minimum": 0,
